...
from shortuuid.shortuuid.django_fields import ShortUUIDField
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cid', ShortUUIDField(alphabet='abcdefghijklmnopqrstuvxyz123', length=5, max_length=25, prefix='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sid', ShortUUIDField(alphabet='abcdefghijklmnopqrstuvxyz', length=10, max_length=25, prefix='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('gid', ShortUUIDField(alphabet='abcdefghijklmnopqrstuvxyz1231234567890', length=10, max_length=25, prefix='')),
