...
if sys.version_info < (3, 9):
    ...
    def evaluate_forwardref(type_: ForwardRef, globalns: Any, localns: Any, recursive_guard: Optional[set] = None) -> Any:
        if recursive_guard is None:
            recursive_guard = set()
        return type_._evaluate(globalns, localns, recursive_guard=recursive_guard)
    ...
    def evaluate_forwardref(type_: ForwardRef, globalns: Any, localns: Any, recursive_guard: Optional[set] = None) -> Any:
        ...
        return cast(Any, type_)._evaluate(globalns, localns, recursive_guard=recursive_guard)
